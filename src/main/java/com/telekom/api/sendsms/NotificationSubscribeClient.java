...
import com.telekom.api.sendsms.model.NotificationSubscribeRequest;

public class NotificationSubscribeClient extends TelekomClient {
	 ...
	 */
	public NotificationSubscribeClient(TelekomAuth authentication,
	 ...
	 */
	public SmsResponse subscribeNotifications(NotificationSubscribeRequest request) throws IOException {
		ensureRequestValid(request);

		String uri = getServiceBaseUrl() + "/outbound/%s/subscriptions";
	...
	private TelekomJsonWebRequest createAuthenticatedJsonRequest(String uri,
			NotificationSubscribeRequest request) throws JsonGenerationException,
		...
		jsonRequest.put("deliveryReceiptSubscription", val);
