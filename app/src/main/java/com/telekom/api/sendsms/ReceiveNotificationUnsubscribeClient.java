...
import com.telekom.api.sendsms.model.ReceiveNotificationUnsubscribeRequest;

public class ReceiveNotificationUnsubscribeClient extends TelekomClient {
	 ...
	 */
	public ReceiveNotificationUnsubscribeClient(TelekomAuth authentication,
	 ...
	 */
	public SmsResponse unsubscribeReceiveNotifications(ReceiveNotificationUnsubscribeRequest request) throws IOException {
		ensureRequestValid(request);

		String uri = getServiceBaseUrl() + "/inbound/subscriptions/%s";
